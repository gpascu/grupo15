    ...
    def get(self, option, default=undefined, cast=undefined):
        ...
        if option in os.environ:
            ...
            if isinstance(default, Undefined):
                raise UndefinedValueError('django-insecure-((z^=t)ag4dk6x^pif!$(7qt-4yg59=5z8cnbp#fwy=1*v@3l( not found. Declare it as envvar or define a default value.'.format(option))
